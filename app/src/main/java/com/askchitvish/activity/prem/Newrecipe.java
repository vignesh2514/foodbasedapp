    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent upIntent = NavUtils.getParentActivityIntent(Newrecipe.this);
                upIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                NavUtils.navigateUpTo(Newrecipe.this, upIntent);
            }
        });
    ...
    public class JSONTask extends AsyncTask<String,String, List<Subcategory> > {
        ...
        protected void onPostExecute(final List<Subcategory> movieModelList) {
            ...
            if(movieModelList != null) {
                MovieA adapter = new MovieA(Newrecipe.this, R.layout.list_cubcate, movieModelList);
                ...
                subcat_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(Newrecipe.this, FromNewRec.class);
                ...
                String json = sharedPrefs.getString("newrecipe", null);
                Type type = new TypeToken<List<Subcategory>>() {}.getType();
                final ArrayList<Subcategory> arrayList = gson.fromJson(json, type);

               MovieA adapter = new MovieA(Newrecipe.this, R.layout.list_cubcate, arrayList);
                subcat_list.setAdapter(adapter);
                subcat_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
